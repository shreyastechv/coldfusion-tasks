    ...
    <body>
		<div class="container mt-5">
			...
			<div class="text-primary-emphasis mt-3">
				<cfif IsDefined("Form.rows") AND IsDefined("Form.columns")>
					<cfset obj = createObject('component', 'comp')>
					<cfset result = obj.printNumbers(Form.rows, Form.columns)>

					<cfloop array="#result#" item="innerArray">
						<cfloop array="#innerArray#" item="element">
							<cfoutput>#element#</cfoutput>
						</cfloop>
						<br>
					</cfloop>
				</cfif>
