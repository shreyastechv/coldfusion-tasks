			...
			<div class="container mt-5">
				...
				<form name="emailForm" method="post" enctype="multipart/form-data">
					<div class="mb-3">
						...
						<input class="form-control" type="text" id="name" name="name" placeholder="Cute Baby Name" required>
					</div>
					<div class="mb-3">
						<label class="form-label" for="email">Enter email id:</label>
						<input class="form-control" type="email" id="email" name="email" placeholder="abc@example.org" required>
					</div>
					<div class="mb-3">
						<label class="form-label" for="bdayMessage">Enter greetings message:</label>
						<textarea class="form-control" id="bdayMessage" name="bdayMessage" placeholder="Enter message here" rows="5" required></textarea>
					</div>
					<div class="mb-3">
